...
class BasicTrainTask(TrainTask):
    ...
    def train_key_metric(self, context: Context):
        return {self.TRAIN_KEY_METRIC: MeanDice(output_transform=from_engine(["pred", "label"]), include_background=False)}
    ...
    def val_key_metric(self, context):
        return {self.VAL_KEY_METRIC: MeanDice(output_transform=from_engine(["pred", "label"]), include_background=False)}

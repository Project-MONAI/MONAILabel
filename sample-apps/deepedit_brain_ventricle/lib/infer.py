...
class Segmentation(InferTask):
    """
    This provides Inference Engine for pre-trained brain ventricle segmentation model.
    """
    ...
    def __init__(
        ...
        labels="brain ventricle",
        dimension=3,
        description="A pre-trained model for volumetric (3D) segmentation of the brain ventricle over 3D MR Images",
    ):
        super().__init__(
            path=path,
            network=network,

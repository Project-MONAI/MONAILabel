...
class SegmentationBrats(TaskConfig):
    def init(self, name: str, model_dir: str, conf: Dict[str, str], planner: Any, **kwargs):
        ...
        # Network
        self.spatial_size = json.loads(self.conf.get("spatial_size", "[128, 128, 96]"))
        # self.network = UNETR(
        #     spatial_dims=3,
    ...
    def infer(self) -> Union[InferTask, Dict[str, InferTask]]:
        task: InferTask = lib.infers.SegmentationDrTure(
            path=self.path,
    ...
    def trainer(self) -> Optional[TrainTask]:
        ...
        task: TrainTask = lib.trainers.SegmentationDrTure(

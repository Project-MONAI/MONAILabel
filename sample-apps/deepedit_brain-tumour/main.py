...
class MyApp(MONAILabelApp):
    def __init__(self, app_dir, studies):
        ...
        # self.val_datastore = LocalDatastore("/home/adp20local/Documents/MONAILabel/datasets/Task02_Heart/validation_imgs/")
    ...
    def train(self, request):
        ...
        # val_d = self.val_datastore().datalist()
        data_dir = "/home/adp20local/Documents/MONAILabel/datasets/Task02_Heart/validation_imgs/"
        train_images = sorted(glob.glob(os.path.join(data_dir, "imagesTr", "*.nii.gz")))
        train_labels = sorted(glob.glob(os.path.join(data_dir, "labelsTr", "*.nii.gz")))
        val_d = [{"image": image_name, "label": label_name} for image_name, label_name in
        ...
        task = MyTrain(
            ...
            val_interval=request.get('val_interval', 2),
        )

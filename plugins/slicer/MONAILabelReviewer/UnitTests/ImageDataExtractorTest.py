...
class ImageDataExtractorTest(unittest.TestCase):
    ...
    def createImageData(self):
        ...
        #is segmented
        imageDataTest_1 = ImageData(name = "imageId_1", fileName = "fileName_1", nodeName = "nodeName_1", checkSum = "checkSum_1", segmented=True, timeStamp=1640171961, comment="comment_1")
        imageDataTest_1.setClientId("client_id_1")
        imageDataTest_1.setSegmentationFileName("testSegementation_1.nrrd")
        imageDataTest_1.setSegmentationMeta(status=self.STATUS.APPROVED, level=self.LEVEL.HARD, approvedBy="theRadologist_1",  comment="comment_1")
        
        #is segmented
        imageDataTest_2 = ImageData(name = "imageId_2", fileName = "fileName_2", nodeName = "nodeName_2", checkSum = "checkSum_2", segmented=True, timeStamp=1640171961, comment="comment_2")
        imageDataTest_2.setClientId("client_id_1")
        imageDataTest_2.setSegmentationFileName("testSegementation_2.nrrd")
        imageDataTest_2.setSegmentationMeta(status=self.STATUS.FLAGGED, level=self.LEVEL.MEDIUM, approvedBy="theRadologist_2",  comment="comment_2")

        #is not segmented
        imageDataTest_3 = ImageData(name = "imageId_3", fileName = "fileName_3", nodeName = "nodeName_3", checkSum = "checkSum_3", segmented=False, timeStamp=1640171961, comment="comment_3")
    ...
    def areEqual(self, imageData_1 : ImageData, imageData_2 : ImageData) -> bool:
        if(imageData_1.getClientId() == imageData_2.getClientId()
    ...
    def test_getAllImageData_segmented_is_true_approved_is_true(self):
        imageDatas = self.imageDataExtractor.getAllImageData(segmented=True, notSegmented=False, approved=True, flagged=False)
    ...
    def test_getAllImageData_segmented_is_true_flagges_is_true(self):
        imageDatas = self.imageDataExtractor.getAllImageData(segmented=True, notSegmented=False, approved=False, flagged=True)
        self.assertEqual(1, len(imageDatas))
        expectedImageData = self.nameToImageData["imageId_2"]
        self.assertEqual(True, self.areEqual(expectedImageData, imageDatas[0]))

    def test_getAllImageData_isNotSegmented_is_false_approved_is_false(self):
        imageDatas = self.imageDataExtractor.getAllImageData(segmented=False, notSegmented=True, approved=False, flagged=False)
        self.assertEqual(1, len(imageDatas))
    ...
    def test_getImageDataByClientId_approved_is_true(self):
        ...
        imageDataTest_4 = ImageData(name = "imageId_4", fileName = "fileName_4", nodeName = "nodeName_4", checkSum = "checkSum_4", segmented=True, timeStamp=1640171961, comment="comment_4")
        imageDataTest_4.setClientId("client_id_1")
        imageDataTest_4.setSegmentationFileName("testSegementation_4.nrrd")
        imageDataTest_4.setSegmentationMeta(status=self.STATUS.APPROVED, level=self.LEVEL.MEDIUM, approvedBy="theRadologist_4",  comment="comment_4")
        ...
        returnedImageDatas = imageDataExtractor.getImageDataByClientId(clientId= "client_id_1", approved=True, flagged=False)
    ...
    def test_getImageDataByClientAndReviewer_approved_is_true(self):
        imageDataExtractor = ImageDataExtractor(nameToImageData = self.nameToImageData)
        imageDataExtractor.init()
        returnedImageDatas = imageDataExtractor.getImageDataByClientAndReviewer(clientId= "client_id_1", reviewerId="theRadologist_1", approved=True, flagged=False)
    ...
    def test_getImageDataByClientId_flagged_is_true(self):
        returnedImageDatas = self.imageDataExtractor.getImageDataByClientId(clientId= "client_id_1", approved=False, flagged=True)
        self.assertEqual(1, len(returnedImageDatas))
    ...
    def test_getImageDataByReviewer_approved_is_true(self):
        returnedImageDatas = self.imageDataExtractor.getImageDataByReviewer(reviewerId= "theRadologist_1", approved=True, flagged=False)
        self.assertEqual(1, len(returnedImageDatas))
        returnedImageData = returnedImageDatas[0]
        expectedImageData = self.nameToImageData["imageId_1"]
        self.assertEqual(True, self.areEqual(expectedImageData, returnedImageData))
    ...
    def test_getImageDataByReviewer_flagged_is_true(self):
        returnedImageDatas = self.imageDataExtractor.getImageDataByReviewer(reviewerId= "theRadologist_2", approved=False, flagged=True)
        self.assertEqual(1, len(returnedImageDatas))
        returnedImageData = returnedImageDatas[0]
        expectedImageData = self.nameToImageData["imageId_2"]
        self.assertEqual(True, self.areEqual(expectedImageData, returnedImageData))
    ...
    def test_getMultImageDataByIds(self):
        returnedImageDatas : Dict[str, ImageData] = self.imageDataExtractor.getMultImageDataByIds(ids=["imageId_1", "imageId_3", "dummy"])
        self.assertEqual(2, len(returnedImageDatas))

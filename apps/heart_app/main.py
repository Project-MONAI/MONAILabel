...
from monailabel.engines.infer import Deepgrow2D, Deepgrow3D
from monailabel.engines.infer.segmentation_heart import SegmentationHeart
    ...
    def __init__(self, app_dir, studies):
        super().__init__(
            ...
            infer_models={
                ...
                "segmentation_heart": (SegmentationHeart, "segmentation_heart.pth"),

...
- Radiology: This app has example models to do both interactive and automated segmentation over radiology (3D) 
...
- Pathology: This app has example models to do both interactive and automated segmentation over pathology (WSI) 
...
- Bundle: The Bundle app enables users with customized models for inference, training or pre and post processing any target 

...
Inspect workspace to resolve names/IDs. “Use Sol from now on” changes selection; “annotate using Sol” belongs to an annotation skill. next_cases only ranks/selects images; it does not segment or submit them. “Next case” means limit=1.
